...
public class TestFluid1 extends SparseMaterial {
    ...
    @Override
    public float diffusionDivision() {return 0.8f;}
    @Override
    public float maxConcentration() {return 3f;}
    @Override
    public Direction getRandomMoveDirection(Random r) {
        return getRandomDirectionBias(0, 4, 1, r);
    }
}
